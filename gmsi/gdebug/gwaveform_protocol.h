#ifndef __GWAVEFORM_PROTOCOL_H__
#define __GWAVEFORM_PROTOCOL_H__

#include <stdint.h>

#define GWAVEFORM_PROTOCOL_MAX_CHANNELS 16
...
typedef struct {
     ...
     * @return uint16_t Length of packed frame
     */
    uint16_t (*pack_desc)(uint8_t *pchBuffer, const gwaveform_ch_desc_t *atChannels, uint8_t chCount);

} gwaveform_protocol_t;

extern const gwaveform_protocol_t default_waveform_protocol;

#endif /* __GWAVEFORM_PROTOCOL_H__ */
